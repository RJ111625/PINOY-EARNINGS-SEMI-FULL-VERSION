...
var qq = Libs.Random.randomInt(1,20)
var question = Libs.Random.randomInt(100,200)
var divide = question / qq
User.setProperty("divide", divide.toFixed(2), "string")
Bot.sendMessage("*➡️ Solve This Captcha Before Using This Bot.\n\n✅ Solve It : "+question+" ÷ "+qq+" = ?*")
Bot.runCommand("divideS")
